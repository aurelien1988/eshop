...
<<<<<<< HEAD
define('RACINE', $_SERVER['DOCUMENT_ROOT'] . '/PHP/deveshop/eshop-dev/');
define('URL', "http://localhost/PHP/deveshop/eshop-dev/");
=======
define('RACINE', $_SERVER['DOCUMENT_ROOT'] . '/PHP/eshop/');
define('URL', "http://localhost/PHP/eshop/");
